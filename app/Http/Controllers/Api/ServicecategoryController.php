...
class ServicecategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validation = Validator::make($data,[ 
            'name' => ['required','string','unique:App\Models\Servicecategory'],
        ...
        if($validation->fails()){
            ...
            if ($request->file('image')) {
                ...
                $image = Image::make(public_path("/storage/{$imagePath}"))->fit(700,500);
    ...
    public function update(Request $request,$id)
    {
        ...
        $validation = Validator::make($data,[ 
            'name' => ['required','string',Rule::unique('App\Models\Servicecategory')->ignore($id)],
            'status' => ['required','numeric'],
            'details' => '',
            'image'=>''
        ]);
