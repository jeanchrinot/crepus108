                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                            ...
                            <tr v-for="(item,index) in items" v-bind:key="item.id">
                                ...
                                <td>{{ getCategory(item.servicecategory_id) }}</td>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                    ...
                                    <select class="form-control" id="category" v-model="item.servicecategory_id">
                                        <option value="">Choisir</option>
                                        <option v-for="cat in itemCats" :value="cat.id">{{ cat.name }}</option>
                                    </select>
                                    <div class="error" v-if="submitTry && !$v.item.servicecategory_id.required">Ce champ est réquis.</div>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
	    ...
	    <div class="main-card mb-3 card">
            <div class="card-body">
                <ul v-if="showItemDetails" class="list-group list-group-flush">
                    ...
                    <li class="justify-content-between list-group-item"><b>Catégorie:</b> {{ getCategory(item.servicecategory_id) }} 
                    </li>
...
<script>
	...
	export default{
		...
		data:()=>({
			...
			itemModule:'ServiceSubcategory',
            itemPath:'service/subcategory',
        ...
        created(){
            ...
            this.$store.dispatch('ServiceCategory/getItems','/api/panel/service/category/all');
        ...
        computed:{
            ...
            MetaAndLinks:{
                get(){
                    return this.$store.state.ServiceSubcategory.pagination;
                }
            },
            pagination:{
                get(){
            ...
            itemCats:{
                get(){
                    return this.$store.state.ServiceCategory.items;
                }
            }
        },
        validations:{
		...
		methods:{
            ...
            saveItem(){
                ...
                if (this.$v.$invalid) {
                    ...
                    if (this.addingItem===true) {
                        // Add new item
                        this.$store.dispatch('ServiceSubcategory/addItem',this.item);
                        
                    }
                    else if (this.editingItem===true) {
                        // Update an item
                        this.$store.dispatch('ServiceSubcategory/updateItem',this.item);
            ...
            updateStatus(id){
                ...
                this.$store.dispatch('ServiceSubcategory/updateStatus',data);
            },
            getCategory(id){
                let cat = this.$store.getters['ServiceCategory/getItemById'](id);
                if('name' in cat){
                    return cat.name 
                }
                else{
