                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="position-relative form-group">
                                    ...
                                    <input type="text" id="name" class="form-control" v-model="item.name" placeholder="Ex: RAKOTONANDRASANA Julien">
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="position-relative form-group">
                                    ...
                                    <input type="text" id="title" class="form-control" v-model="item.title" placeholder="Ex: Cliente satisfaite">
                                    <div class="error" v-if="submitTry && !$v.item.title.required">Ce champ est réquis.</div>
                                </div>
                            </div>
                        </div>
                        <div class="position-relative form-group">
                            <label for="quote" class="">Témignage (Citation) </label>
                            <textarea name="text" id="quote" class="form-control" v-model="item.quote"></textarea>
                            <div class="error" v-if="submitTry && !$v.item.quote.required">Ce champ est réquis.</div>
                        </div>
                        <div class="position-relative form-group">
	    ...
	    <div class="main-card mb-3 card">
            <div class="card-body">
                <ul v-if="showItemDetails" class="list-group list-group-flush">
                    ...
                    <li class="justify-content-between list-group-item"><b>Témoignage:</b><br>
                    <p>{{ AvoidNullValue(item.quote) }}</p>
                    </li>
...
<script>
	...
	export default{
		...
		data:()=>({
            ...
            itemTitle:'Témoignages',
			itemModule:'Testimonial',
            itemPath:'testimonial',
        ...
        computed:{
            items:{
                get(){
                    return this.$store.state.Testimonial.items;
                }
            },
            MetaAndLinks:{
                get(){
                    return this.$store.state.Testimonial.pagination;
                }
            },
            pagination:{
                get(){
