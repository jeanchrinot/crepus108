        <!-- SLIDER START -->
            <div id="rev_slider_1050_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="webproduct-light" data-source="gallery" style="background-color:transparent;padding:0px;">
                ...
                <div id="rev_slider_1050_1" class="slider slider-dots rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                    <ul>   
                    @foreach($sliders as $key => $slider) 
                        <!-- SLIDE  -->
                        <li data-index="rs-{{ $key+1 }}" data-transition="slideleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"   data-thumb="images/gallery/Slider-BG-RopePattern.jpg"  data-rotate="0"  data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="Additional Text" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="images/gallery/Slider-BG-RopePattern.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                           
                    
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption WebProduct-Title   tp-resizeme" 
                                id="slide-{{ $key+1 }}-layer-01" 
                                ...
                                <div class="text-secondry"> {{ $slider->title_1 }}</div>
                                </div>
                            ...
                            <div class="tp-caption WebProduct-SubTitle   tp-resizeme" 
                                ...
                                <div class="text-secondry">
                                    <span class="text-primary"> {{ $slider->title_2 }}</span>
                                </div>
                                </div>
                            ...
                            <div class="tp-caption tp-resizeme" 
                               ...
                               <a href="{{ route('service.index') }}" class="site-button radius-sm button-lg">Tous nos services</a>
                               </div>
                            <!-- LAYER NR. 5 -->
                            ...
                            <!-- <div class="tp-caption tp-resizeme" 
                                ...
                                style="z-index:13; text-transform:uppercase; font-weight:700;">
                               <a href="javascript:;" class="site-button-secondry radius-sm button-lg">Plus de détails</a>
                               </div> -->
